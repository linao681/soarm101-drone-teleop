  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xf0, 0x95, 0x7b, 0xe0, 0xa6, 0x39, 0x43, 0xaf,
      0x8b, 0x24, 0xab, 0xcb, 0x20, 0xe4, 0xe1, 0xfc,
      0x8b, 0x71, 0x36, 0x8e, 0x87, 0x2d, 0xbf, 0x80,
      0x2f, 0x87, 0xb8, 0xa2, 0xca, 0x8e, 0x60, 0xa0,
    }};
  return &hash;
}
...
static char geometry_msgs__msg__VelocityWithCovarianceStamped__TYPE_NAME[] = "geometry_msgs/msg/VelocityWithCovarianceStamped";
...
static char geometry_msgs__msg__VelocityWithCovarianceStamped__FIELD_NAME__header[] = "header";
static char geometry_msgs__msg__VelocityWithCovarianceStamped__FIELD_NAME__body_frame_id[] = "body_frame_id";
static char geometry_msgs__msg__VelocityWithCovarianceStamped__FIELD_NAME__reference_frame_id[] = "reference_frame_id";
static char geometry_msgs__msg__VelocityWithCovarianceStamped__FIELD_NAME__velocity[] = "velocity";

static rosidl_runtime_c__type_description__Field geometry_msgs__msg__VelocityWithCovarianceStamped__FIELDS[] = {
  {
    {geometry_msgs__msg__VelocityWithCovarianceStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geometry_msgs__msg__VelocityWithCovarianceStamped__FIELD_NAME__body_frame_id, 13, 13},
    {
  ...
  {
    {geometry_msgs__msg__VelocityWithCovarianceStamped__FIELD_NAME__reference_frame_id, 18, 18},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {geometry_msgs__msg__VelocityWithCovarianceStamped__FIELD_NAME__velocity, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geometry_msgs__msg__VelocityWithCovarianceStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {geometry_msgs__msg__VelocityWithCovarianceStamped__TYPE_NAME, 47, 47},
      {geometry_msgs__msg__VelocityWithCovarianceStamped__FIELDS, 4, 4},
    },
    {geometry_msgs__msg__VelocityWithCovarianceStamped__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
geometry_msgs__msg__VelocityWithCovarianceStamped__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geometry_msgs__msg__VelocityWithCovarianceStamped__get_individual_type_description_source(NULL),

...
static char nav_msgs__msg__TrajectoryPoint__FIELD_NAME__header[] = "header";
static char nav_msgs__msg__TrajectoryPoint__FIELD_NAME__pose[] = "pose";
static char nav_msgs__msg__TrajectoryPoint__FIELD_NAME__velocity[] = "velocity";
static char nav_msgs__msg__TrajectoryPoint__FIELD_NAME__acceleration[] = "acceleration";
static char nav_msgs__msg__TrajectoryPoint__FIELD_NAME__effort[] = "effort";

static rosidl_runtime_c__type_description__Field nav_msgs__msg__TrajectoryPoint__FIELDS[] = {
  {
    {nav_msgs__msg__TrajectoryPoint__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {nav_msgs__msg__TrajectoryPoint__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav_msgs__msg__TrajectoryPoint__FIELD_NAME__velocity, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav_msgs__msg__TrajectoryPoint__FIELD_NAME__acceleration, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav_msgs__msg__TrajectoryPoint__FIELD_NAME__effort, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription nav_msgs__msg__TrajectoryPoint__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {nav_msgs__msg__TrajectoryPoint__FIELDS, 5, 5},
    },
    {nav_msgs__msg__TrajectoryPoint__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
...
nav_msgs__msg__TrajectoryPoint__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *nav_msgs__msg__TrajectoryPoint__get_individual_type_description_source(NULL),

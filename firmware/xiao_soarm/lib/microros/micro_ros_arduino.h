...
static inline void set_microros_wifi_transports(char * ssid, char * pass, char * agent_ip, uint32_t agent_port){
	...
	// The application may already have established WiFi. Calling WiFi.begin()
	// again while connected starts another asynchronous association cycle and
	// can invalidate UDP traffic during micro-ROS entity creation.
